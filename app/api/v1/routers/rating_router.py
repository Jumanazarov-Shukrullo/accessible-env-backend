...
class RatingRouter:
    ...
    async def add_rating(
        ...
        logger.info(
            f"Adding rating for location {location_id} by user {
    ...
    async def get_my_rating(
        ...
        logger.info(
            f"Getting user rating for location {location_id} by user {
                current_user.user_id}")
    ...
    async def delete_my_rating(
        ...
        logger.info(
            f"Deleting user rating for location {location_id} by user {
                current_user.user_id}")
