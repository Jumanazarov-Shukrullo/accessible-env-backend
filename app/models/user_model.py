...
class User(Base):
    ...
    role_id: Mapped[Optional[int]] = mapped_column(
        Integer, ForeignKey("roles.role_id", ondelete="SET NULL")
    )
    ...
    ratings = relationship(
        "LocationRating", back_populates="user", cascade="all, delete-orphan"
    )
    ...
    assessments = relationship(
        ...
        foreign_keys="LocationSetAssessment.assessor_id",
        cascade="all, delete-orphan",
    )
    verifications = relationship(
        "LocationSetAssessment",
        foreign_keys="LocationSetAssessment.verifier_id",
        cascade="all, delete-orphan",
    )
...
class UserSecurity(Base):
    ...
    password_reset_token_expires: Mapped[Optional[dt.datetime]] = (
    ...
    password_changed_at: Mapped[Optional[dt.datetime]] = mapped_column(
        DateTime(timezone=True)
    )
    created_at: Mapped[dt.datetime] = mapped_column(
        DateTime(timezone=True), default=dt.datetime.utcnow
