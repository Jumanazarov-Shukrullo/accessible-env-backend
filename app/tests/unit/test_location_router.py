...
class TestLocationRouter:
    ...
    def test_list_locations_success(self, client):
        ...
        with patch('app.api.v1.dependencies.get_uow') as mock_uow, \
             patch('app.services.location_service.LocationService') as mock_service:
            ...
            mock_service.return_value.get_all_locations.return_value = mock_locations
    ...
    def test_get_location_success(self, client, sample_location):
        ...
        with patch('app.api.v1.dependencies.get_uow') as mock_uow, \
            ...
            mock_service.return_value.get_location.return_value = sample_location.__dict__
    ...
    def test_get_location_not_found(self, client):
        ...
        with patch('app.api.v1.dependencies.get_uow') as mock_uow, \
            ...
            mock_service.return_value.get_location.side_effect = LocationNotFound("Location not found")
    ...
    def test_create_location_success(self, client, admin_user):
        ...
        with patch('app.api.v1.dependencies.get_uow') as mock_uow, \
            ...
            mock_service.return_value.create_location.return_value = {**location_data, "location_id": str(uuid4())}
    ...
    def test_update_location_success(self, client, admin_user, sample_location):
        ...
        with patch('app.api.v1.dependencies.get_uow') as mock_uow, \
            ...
            mock_service.return_value.update_location.return_value = updated_location
    ...
    def test_get_popular_locations(self, client):
        ...
        with patch('app.api.v1.dependencies.get_uow') as mock_uow, \
            ...
            mock_locations = [{"location_id": str(uuid4()), "location_name": "Popular Location"}]
            mock_service.return_value.get_popular_locations.return_value = mock_locations
    ...
    def test_get_recently_rated_locations(self, client):
        ...
        with patch('app.api.v1.dependencies.get_uow') as mock_uow, \
            ...
            mock_locations = [{"location_id": str(uuid4()), "location_name": "Recent Location"}]
            mock_service.return_value.get_recently_rated_locations.return_value = mock_locations
    ...
    def test_get_by_category(self, client):
        ...
        with patch('app.api.v1.dependencies.get_uow') as mock_uow, \
            ...
            mock_locations = [{"location_id": str(uuid4()), "category_id": category_id}]
            mock_service.return_value.get_by_category.return_value = mock_locations
            
            response = client.get(f"/api/v1/locations/by_category/{category_id}")
    ...
    def test_get_by_region(self, client):
        ...
        with patch('app.api.v1.dependencies.get_uow') as mock_uow, \
            ...
            mock_locations = [{"location_id": str(uuid4()), "region_id": region_id}]
            mock_service.return_value.get_by_region.return_value = mock_locations
    ...
    def test_assign_inspector_success(self, client, admin_user):
        ...
        with patch('app.api.v1.dependencies.get_uow') as mock_uow, \
            ...
            response = client.post(f"/api/v1/locations/{location_id}/inspectors/{user_id}")
    ...
    def test_remove_inspector_success(self, client, admin_user):
        ...
        with patch('app.api.v1.dependencies.get_uow') as mock_uow, \
            ...
            response = client.delete(f"/api/v1/locations/{location_id}/inspectors/{user_id}")
    ...
    def test_get_location_stats(self, client):
        ...
        with patch('app.api.v1.dependencies.get_uow') as mock_uow, \
            ...
            mock_service.return_value.get_location_stats.return_value = mock_stats
    ...
    def test_server_error_handling(self, client):
        ...
        with patch('app.api.v1.dependencies.get_uow') as mock_uow, \
            ...
            mock_service.return_value.get_all_locations.side_effect = Exception("Database error")
