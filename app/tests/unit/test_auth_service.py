...
class TestAuthService:
    ...
    def test_register_user_email_exists(self, auth_service, mock_uow, sample_user):
    ...
    def test_register_user_username_exists(self, auth_service, mock_uow, sample_user):
    ...
    def test_authenticate_user_success(self, auth_service, mock_uow, sample_user):
        ...
        with patch('app.services.auth_service.verify_password') as mock_verify:
            ...
            mock_verify.assert_called_once_with("password123", sample_user.password_hash)
    ...
    def test_authenticate_user_wrong_password(self, auth_service, mock_uow, sample_user):
    ...
    def test_authenticate_user_inactive(self, auth_service, mock_uow, sample_user):
    ...
    def test_verify_email_success(self, auth_service, mock_uow, sample_user):
        ...
        with patch('app.services.auth_service.verify_email_token') as mock_verify:
    ...
    def test_verify_email_invalid_token(self, auth_service):
        ...
        with patch('app.services.auth_service.verify_email_token') as mock_verify:
            ...
            with pytest.raises(ValidationError, match="Invalid verification token"):
    ...
    def test_change_password_success(self, auth_service, mock_uow, sample_user):
    ...
    def test_refresh_token_success(self, auth_service, mock_uow, sample_user):
        ...
        with patch('app.services.auth_service.verify_refresh_token') as mock_verify, \
    ...
    def test_get_user_from_token_success(self, auth_service, mock_uow, sample_user):
