...
class TestLocationRoutes:
    ...
    def test_create_location_invalid_coordinates(
    ...
    def test_get_location_by_id_success(
        self, client: TestClient, sample_location
    ):
        """Test successful location retrieval by ID."""
        # Act
        response = client.get(
            f"/api/v1/locations/{sample_location.location_id}"
        )
    ...
    def test_get_locations_with_filters(
        self, client: TestClient, sample_category
    ):
        """Test locations retrieval with filters."""
        # Act
        response = client.get(
            f"/api/v1/locations/?category_id={sample_category.category_id}&status=active"
        )
    ...
    def test_search_locations_success(self, client: TestClient):
        ...
        # Arrange
        search_params = {"query": "test", "limit": 10, "offset": 0}
    ...
    def test_update_location_success(
        self, client: TestClient, admin_auth_headers, sample_location
    ):
    ...
    def test_update_location_unauthorized(
        self, client: TestClient, auth_headers, sample_location
    ):
    ...
    def test_update_location_details_success(
        ...
        # Act
        response = client.put(
            f"/api/v1/locations/{sample_location.location_id}/details",
            json=details_data,
            headers=admin_auth_headers,
        )
    ...
    def test_delete_location_unauthorized(
        self, client: TestClient, auth_headers, sample_location
    ):
    ...
    def test_delete_location_not_found(
        ...
        # Act
        response = client.delete(
            "/api/v1/locations/nonexistent-id", headers=admin_auth_headers
        )
    ...
    def test_add_location_to_favourites_success(
        ...
        # Act
        response = client.post(
            f"/api/v1/locations/{sample_location.location_id}/favourites",
            headers=auth_headers,
        )
    ...
    def test_add_location_to_favourites_unauthorized(
        self, client: TestClient, sample_location
    ):
    ...
    def test_rate_location_success(
        self, client: TestClient, auth_headers, sample_location
    ):
        ...
        # Act
        response = client.post(
            f"/api/v1/locations/{sample_location.location_id}/ratings",
            json=rating_data,
            headers=auth_headers,
        )
    ...
    def test_rate_location_invalid_value(
        self, client: TestClient, auth_headers, sample_location
    ):
    ...
    def test_rate_location_unauthorized(
        self, client: TestClient, sample_location
    ):
    ...
    def test_get_user_favourites_success(
        ...
        # Act
        response = client.get(
            "/api/v1/locations/favourites", headers=auth_headers
        )
    ...
    def test_get_user_favourites_with_pagination(
        self, client: TestClient, auth_headers
    ):
        """Test user favourites retrieval with pagination."""
        # Act
        response = client.get(
            "/api/v1/locations/favourites?page=1&size=5", headers=auth_headers
        )
    ...
    def test_upload_location_image_success(
        self,
        client: TestClient,
        admin_auth_headers,
        sample_location,
        ...
        # Act
        response = client.post(
            f"/api/v1/locations/{sample_location.location_id}/images",
            files=files,
            data=data,
            headers=admin_auth_headers,
        )
    ...
    def test_upload_location_image_unauthorized(
        self, client: TestClient, auth_headers, sample_location
    ):
    ...
    def test_upload_location_image_invalid_format(
        self, client: TestClient, admin_auth_headers, sample_location
    ):
    ...
    def test_get_location_images_success(
        self, client: TestClient, sample_location
    ):
    ...
    def test_delete_location_image_success(
        self, client: TestClient, admin_auth_headers, sample_location
    ):
        ...
        # Act
        response = client.delete(
            f"/api/v1/locations/{sample_location.location_id}/images/{image_id}",
            headers=admin_auth_headers,
        )
    ...
    def test_delete_location_image_unauthorized(
        self, client: TestClient, auth_headers, sample_location
    ):
    ...
    def test_bulk_update_location_status_unauthorized(
        self, client: TestClient, auth_headers
    ):
        """Test bulk status update fails for unauthorized user."""
        # Arrange
        update_data = {"location_ids": ["id1", "id2"], "status": "inactive"}
    ...
    def test_get_location_statistics_success(
        self, client: TestClient, sample_location
    ):
        """Test successful location statistics retrieval."""
        # Act
        response = client.get(
            f"/api/v1/locations/{sample_location.location_id}/statistics"
        )
    ...
    def test_get_location_nearby_success(
        self, client: TestClient, sample_location
    ):
    ...
    def test_get_locations_by_category_success(
        self, client: TestClient, sample_category
    ):
        """Test successful locations retrieval by category."""
        # Act
        response = client.get(
            f"/api/v1/locations/category/{sample_category.category_id}"
        )
    ...
    def test_get_locations_by_region_success(
        self, client: TestClient, sample_region
    ):
        """Test successful locations retrieval by region."""
        # Act
        response = client.get(
            f"/api/v1/locations/region/{sample_region.region_id}"
        )
    ...
    def test_export_locations_csv_success(
        self, client: TestClient, admin_auth_headers
    ):
        """Test successful location export as CSV."""
        # Act
        response = client.get(
            "/api/v1/locations/export/csv", headers=admin_auth_headers
        )
    ...
    def test_export_locations_json_success(
        self, client: TestClient, admin_auth_headers
    ):
        """Test successful location export as JSON."""
        # Act
        response = client.get(
            "/api/v1/locations/export/json", headers=admin_auth_headers
        )
    ...
    def test_export_locations_unauthorized(
        self, client: TestClient, auth_headers
    ):
        """Test location export fails for unauthorized user."""
        # Act
        response = client.get(
            "/api/v1/locations/export/csv", headers=auth_headers
        )
    ...
    def test_import_locations_success(
        ...
        # Act
        response = client.post(
            "/api/v1/locations/import", files=files, headers=admin_auth_headers
        )
    ...
    def test_import_locations_unauthorized(
        self, client: TestClient, auth_headers
    ):
        ...
        # Act
        response = client.post(
            "/api/v1/locations/import", files=files, headers=auth_headers
        )

        # Assert
        assert response.status_code == 403

    def test_import_locations_invalid_format(
        self, client: TestClient, admin_auth_headers
    ):
