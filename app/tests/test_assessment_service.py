...
from app.models.assessment_model import LocationSetAssessment, AssessmentSet, AccessibilityCriteria, AssessmentResponse
from app.models.user_model import User
from app.schemas.assessment_schema import AssessmentCreate, AssessmentUpdate, AssessmentSetCreate
...
class TestAssessmentService:
    ...
    def test_create_assessment_success(self, assessment_service, mock_uow, sample_location, sample_user):
        ...
        assessment_data = AssessmentCreate(
            ...
            responses=[
                ...
                {"criterion_id": 2, "score": 9, "comments": "Excellent parking"}
            ]
        )
        ...
        with patch.object(assessment_service, 'get_assessment_by_id') as mock_get:
    ...
    def test_get_assessment_by_id_success(self, assessment_service, mock_uow):
        ...
        mock_uow.session.query.return_value.options.return_value.filter.return_value.first.return_value = mock_assessment
    ...
    def test_get_assessment_by_id_not_found(self, assessment_service, mock_uow):
    ...
    def test_get_assessments_by_location_success(self, assessment_service, mock_uow, sample_location):
        ...
        # Act
        result = assessment_service.get_assessments_by_location(sample_location.location_id, page=1, size=10)
        
        # Assert
        assert len(result.items) == 3
        assert result.total == 3

    def test_get_assessments_by_user_success(self, assessment_service, mock_uow, sample_user):
        ...
        # Act
        result = assessment_service.get_assessments_by_user(sample_user.user_id, page=1, size=10)
        
        # Assert
        assert len(result.items) == 2
        assert result.total == 2

    def test_update_assessment_success(self, assessment_service, mock_uow, sample_user):
        ...
        mock_uow.session.query.return_value.filter.return_value.first.return_value = mock_assessment
        
        with patch.object(assessment_service, 'get_assessment_by_id') as mock_get:
            mock_get.return_value = Mock()
            
            # Act
            result = assessment_service.update_assessment(assessment_id, assessment_update, sample_user)
    ...
    def test_update_assessment_unauthorized(self, assessment_service, mock_uow, sample_user):
        ...
        with pytest.raises(Exception):  # Should raise HTTPException
            assessment_service.update_assessment(assessment_id, assessment_update, sample_user)

    def test_submit_assessment_success(self, assessment_service, mock_uow, sample_user):
        ...
        with patch.object(assessment_service, 'get_assessment_by_id') as mock_get:
            ...
            # Act
            result = assessment_service.submit_assessment(assessment_id, sample_user)
    ...
    def test_submit_assessment_already_submitted(self, assessment_service, mock_uow, sample_user):
    ...
    def test_verify_assessment_success(self, assessment_service, mock_uow, sample_user):
        ...
        with patch.object(assessment_service, 'get_assessment_by_id') as mock_get:
            ...
            # Act
            result = assessment_service.verify_assessment(assessment_id, verification_comment, sample_user)
    ...
    def test_reject_assessment_success(self, assessment_service, mock_uow, sample_user):
        ...
        with patch.object(assessment_service, 'get_assessment_by_id') as mock_get:
            ...
            # Act
            result = assessment_service.reject_assessment(assessment_id, rejection_reason, sample_user)
    ...
    def test_delete_assessment_success(self, assessment_service, mock_uow, sample_user):
        ...
        # Act
        result = assessment_service.delete_assessment(assessment_id, sample_user)
    ...
    def test_delete_assessment_unauthorized(self, assessment_service, mock_uow, sample_user):
    ...
    def test_create_assessment_set_success(self, assessment_service, mock_uow, sample_user):
        ...
        with patch.object(assessment_service, 'get_assessment_set_by_id') as mock_get:
            mock_get.return_value = Mock()
            
            # Act
            result = assessment_service.create_assessment_set(set_data, sample_user)
    ...
    def test_get_assessment_set_by_id_success(self, assessment_service, mock_uow):
        """Test successful assessment set retrieval by ID."""
        # Arrange
        set_id = 1
        mock_set = Mock(spec=AssessmentSet)
        mock_set.set_id = set_id
        mock_uow.session.query.return_value.options.return_value.filter.return_value.first.return_value = mock_set
    ...
    def test_get_all_assessment_sets_success(self, assessment_service, mock_uow):
    ...
    def test_get_accessibility_criteria_success(self, assessment_service, mock_uow):
    ...
    def test_calculate_location_accessibility_score_success(self, assessment_service, mock_uow, sample_location):
        ...
        # Act
        result = assessment_service.calculate_location_accessibility_score(sample_location.location_id)
        
        # Assert
        assert result == 8.0  # Average of 7.0, 8.0, 9.0

    def test_calculate_location_accessibility_score_no_assessments(self, assessment_service, mock_uow, sample_location):
    ...
    def test_get_pending_assessments_success(self, assessment_service, mock_uow):
    ...
    def test_get_assessment_statistics_success(self, assessment_service, mock_uow):
        ...
        with patch.object(assessment_service, '_get_assessment_count_by_status') as mock_count:
            mock_count.side_effect = [100, 15, 75, 10]  # Total, pending, verified, rejected
            
            with patch.object(assessment_service, '_get_average_assessment_score') as mock_avg:
    ...
    def test_bulk_verify_assessments_success(self, assessment_service, mock_uow, sample_user):
        ...
        # Act
        result = assessment_service.bulk_verify_assessments(assessment_ids, verification_comment, sample_user)
    ...
    def test_export_assessments_csv_success(self, assessment_service, mock_uow):
