...
from app.schemas.user_schema import UserCreate, UserResponse, InviteCreate
...
class TestUserRoutes:
    ...
    def test_login_user_invalid_credentials(self, client: TestClient, sample_user):
    ...
    def test_upload_profile_picture_success(self, client: TestClient, auth_headers, mock_minio):
    ...
    def test_upload_profile_picture_invalid_file(self, client: TestClient, auth_headers):
    ...
    def test_verify_email_success(self, client: TestClient):
        ...
        # Arrange
        with patch('app.core.security.security_manager.verify_token') as mock_verify:
            mock_verify.return_value = {"email": "test@example.com"}
            
            # Act
            response = client.get("/api/v1/users/verify-email?token=valid_token")
    ...
    def test_create_user_admin_success(self, client: TestClient, admin_auth_headers):
        ...
        # Act
        response = client.post("/api/v1/users/admin/create", json=user_data, headers=admin_auth_headers)
    ...
    def test_create_user_admin_unauthorized(self, client: TestClient, auth_headers):
        ...
        # Act
        response = client.post("/api/v1/users/admin/create", json=user_data, headers=auth_headers)
        
        # Assert
        assert response.status_code == 403

    def test_get_users_admin_success(self, client: TestClient, admin_auth_headers):
        """Test successful retrieval of users by admin."""
        # Act
        response = client.get("/api/v1/users/admin/users", headers=admin_auth_headers)
    ...
    def test_get_users_admin_with_pagination(self, client: TestClient, admin_auth_headers):
        """Test user retrieval with pagination parameters."""
        # Act
        response = client.get("/api/v1/users/admin/users?page=1&size=5", headers=admin_auth_headers)
    ...
    def test_get_users_admin_with_search(self, client: TestClient, admin_auth_headers):
        """Test user retrieval with search parameter."""
        # Act
        response = client.get("/api/v1/users/admin/users?search=test", headers=admin_auth_headers)
        
        # Assert
        assert response.status_code == 200

    def test_get_users_admin_unauthorized(self, client: TestClient, auth_headers):
    ...
    def test_get_user_by_id_admin_success(self, client: TestClient, admin_auth_headers, sample_user):
        """Test successful retrieval of specific user by admin."""
        # Act
        response = client.get(f"/api/v1/users/admin/users/{sample_user.user_id}", headers=admin_auth_headers)
    ...
    def test_get_user_by_id_admin_not_found(self, client: TestClient, admin_auth_headers):
        """Test user retrieval by ID fails when user not found."""
        # Act
        response = client.get("/api/v1/users/admin/users/nonexistent-id", headers=admin_auth_headers)
        
        # Assert
        assert response.status_code == 404

    def test_update_user_admin_success(self, client: TestClient, admin_auth_headers, sample_user):
        ...
        # Act
        response = client.put(f"/api/v1/users/admin/users/{sample_user.user_id}", 
    ...
    def test_deactivate_user_admin_success(self, client: TestClient, admin_auth_headers, sample_user):
        """Test successful user deactivation by admin."""
        # Act
        response = client.post(f"/api/v1/users/admin/users/{sample_user.user_id}/deactivate", 
    ...
    def test_activate_user_admin_success(self, client: TestClient, admin_auth_headers, sample_user):
        """Test successful user activation by admin."""
        # Act
        response = client.post(f"/api/v1/users/admin/users/{sample_user.user_id}/activate", 
                             headers=admin_auth_headers)
    ...
    def test_delete_user_admin_success(self, client: TestClient, admin_auth_headers, sample_user):
        """Test successful user deletion by admin."""
        # Act
        response = client.delete(f"/api/v1/users/admin/users/{sample_user.user_id}", 
                               headers=admin_auth_headers)
    ...
    def test_admin_operations_unauthorized(self, client: TestClient, auth_headers, sample_user):
    ...
    def test_request_password_reset_success(self, client: TestClient, sample_user, mock_email_service):
    ...
    def test_confirm_password_reset_success(self, client: TestClient):
        ...
        with patch('app.core.security.security_manager.verify_token') as mock_verify:
            ...
            # Act
            response = client.post("/api/v1/users/password-reset/confirm", json=reset_data)
    ...
    def test_refresh_token_success(self, client: TestClient, sample_user):
        ...
        with patch('app.core.security.security_manager.verify_token') as mock_verify:
            mock_verify.return_value = {"sub": sample_user.username, "user_id": sample_user.user_id}
            
            # Act
            response = client.post("/api/v1/users/refresh-token", 
