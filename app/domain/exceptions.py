...
class UserAlreadyExists(UserException):
    ...
    def __init__(self, field: str, value: str):
        super().__init__(f"User with {field} '{value}' already exists", "USER_ALREADY_EXISTS")
...
class UserAlreadyVerified(UserException):
    ...
    def __init__(self):
        super().__init__("User email is already verified", "USER_ALREADY_VERIFIED")
...
class InvalidVerificationToken(UserException):
    ...
    def __init__(self):
        super().__init__("Invalid or expired verification token", "INVALID_VERIFICATION_TOKEN")
...
class InsufficientPermissions(PermissionException):
    ...
    def __init__(self, action: str):
        super().__init__(f"Insufficient permissions for action: {action}", "INSUFFICIENT_PERMISSIONS")
...
class CannotModifySuperAdmin(PermissionException):
    ...
    def __init__(self, action: str):
        super().__init__(f"Cannot {action} superadmin users", "CANNOT_MODIFY_SUPERADMIN")
...
class CannotModifySelf(PermissionException):
    ...
    def __init__(self, action: str):
        super().__init__(f"Cannot {action} your own account", "CANNOT_MODIFY_SELF")
...
class InvalidRoleAssignment(PermissionException):
    ...
    def __init__(self, reason: str):
        super().__init__(f"Invalid role assignment: {reason}", "INVALID_ROLE_ASSIGNMENT")
...
class LocationNotFound(LocationException):
    ...
    def __init__(self, location_id: str):
        super().__init__(f"Location not found: {location_id}", "LOCATION_NOT_FOUND")
...
class AssessmentNotFound(AssessmentException):
    ...
    def __init__(self, assessment_id: int):
        super().__init__(f"Assessment not found: {assessment_id}", "ASSESSMENT_NOT_FOUND")
...
class AssessmentNotOwned(AssessmentException):
    ...
    def __init__(self):
        super().__init__("You don't have permission to modify this assessment", "ASSESSMENT_NOT_OWNED")
...
class DistrictNotFound(GeoException):
    ...
    def __init__(self, district_id: int):
        super().__init__(f"District not found: {district_id}", "DISTRICT_NOT_FOUND")
...
class DuplicateGeoEntity(GeoException):
    ...
    def __init__(self, entity_type: str, field: str, value: str):
        super().__init__(f"Duplicate {entity_type} {field}: {value}", "DUPLICATE_GEO_ENTITY")
...
class InvalidDataFormat(ValidationException):
    ...
    def __init__(self, field: str, expected_format: str):
        super().__init__(f"Invalid format for {field}, expected: {expected_format}", "INVALID_DATA_FORMAT")
...
class RequiredFieldMissing(ValidationException):
    ...
    def __init__(self, field: str):
        super().__init__(f"Required field missing: {field}", "REQUIRED_FIELD_MISSING")


class InvalidRange(ValidationException):
    """Value is outside allowed range."""
    
    def __init__(self, field: str, min_val: float, max_val: float, actual: float):
        super().__init__(
...
class ResourceNotFound(ResourceException):
    ...
    def __init__(self, resource_type: str, resource_id: str):
        super().__init__(f"{resource_type} not found: {resource_id}", "RESOURCE_NOT_FOUND")
...
class ResourceConflict(ResourceException):
    ...
    def __init__(self, resource_type: str, conflict_reason: str):
        super().__init__(f"{resource_type} conflict: {conflict_reason}", "RESOURCE_CONFLICT") 